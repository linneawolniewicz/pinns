...
class PINN(tf.keras.Model):
    ...
    '''
    def fit(self, client, trial, P_predict, alpha=1, batchsize=64, boundary_batchsize=16, epochs=20, lr=3e-3, 
            size=256, save=False, load_epoch=-1, lr_decay=-1, alpha_decay=-1, patience=3, filename=''):
